...
[^option]: 루비 온 레일즈 <sup>Ruby on Rails</sup> 나 랙 <sup>Rack</sup>등 루비 기반 환경설정 파일에서 [옵션](https://sass-lang.com/documentation/file.SASS_REFERENCE.html#Options)을 설정할 수 있습니다.
