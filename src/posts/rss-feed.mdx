...
<p className="code-label code-label-xml">https://heyjihye.netlify.app/rss.xml 예시</p>
...
<p className="code-label code-label-html">https://heyjihye.netlify.app/blog/index.html 예시</p>
