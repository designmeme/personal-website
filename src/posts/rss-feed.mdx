...
image: ../images/post/rss-feed-v2.png
...
어그리게이터 <sup>Aggregator</sup>, 뉴스 리더 모두 같은 말이라고 보면 됩니다.
...
<dl>
    ...
    <dd>
        ...
        콘텐츠 웹페이지 URL `https://heyjihye.netlify.app/blog/sass-identifiers/` 등 형태는 상관없어요.
