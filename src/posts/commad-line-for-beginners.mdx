...
명령행 프로그램은 본 셸 <sup>Bourne Shell, sh</sup>, 본 어게인 셸 <sup>Bourne-Again Shell, bash</sup>, 지셸 <sup>Z Shell, zsh</sup>, 명령 프롬프트 <sup>Command Prompt</sup> 등 다양한 셸 프로그램이 있으며 운영체제마다 기본 프로그램이 달라요.
