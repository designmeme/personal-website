...
<div className="lead">
    Sass는 CSS 확장 언어입니다. 여기에는 변수, 믹스인, 함수 등 여러 기능이 있지만, 가장 기본은 **CSS 확장 기능** <sup>CSS Extensions</sup>이라 할 수 있습니다.
...
## 중첩
중첩 <sup>Nesting</sup>은 CSS의 문법을 응용하여, **선택자나 속성의 관계**를 중첩 형태로 풀어낸 문법입니다.
...
규칙 중첩 <sup>Nested Rules</sup>은 부모 선택자를 계속 반복하지 않게 해줍니다.
...
### 플레이스홀더 선택자 `%`
Sass는 '플레이스홀더 선택자 <sup>placeholder selector</sup>&rsquo;라는 특수한 형태의 선택자를 제공합니다.
