...
2. SVG 아이콘을 만들기 위한 **핵심 기능**이 있는 `fontawesome-svg-core` 패키지를 설치해요.<br/>
    <span className={'text-sm'}>💁‍♀️ 어떤 역할을 하는지 궁금하다면 → [SVG Core](https://fontawesome.com/v6/docs/web/dig-deeper/svg-core)</span>
...
Gatsby는 정적 사이트 생성기 <sup>Static Site Generator</sup>에요.
