...
const AboutPage: React.FC<PageProps> = () => {
    ...
    return (
        <PageLayout frontmatter={frontmatter}>
            <p>
                홍익대학교에서 산업디자인과를 졸업 후 만들고 싶은 웹사이트가 있어 독학으로 개발을 배우기 시작했습니다.
                좀 더 성장하기 위해 프리랜서 시장에 뛰어들어 15년 넘게 프론트엔드 개발자로 일했습니다.
                저를 믿어준 분들 만나 스타트업에서 일하면서 스타트업 문화와 스타트업에서 일하는 방식도 알차게 배울 수 있었습니다.
            </p>
            <hr/>

            <h5>프리랜서 프론트엔드 개발자</h5>
            ...
            <ul>
                <li>
                    ...
                    <br/>
                    <div className="p-small" style={{marginTop: '-2px'}}>SEO / SSR / Analytics / UX / Lighthouse</div>
                </li>
                <li>
                    <b>업무 효율성을 올리는 어드민</b>
                    <br/>
                    ...
                    <br/>
                    <div className="p-small" style={{marginTop: '-2px'}}>Design system / Data Grid / Chart / Calendar UI / Drag and Drop / Shortcuts</div>
                </li>
                <li>
                    ...
                    <br/>
                    <div className="p-small" style={{marginTop: '-2px'}}>Scroll Animation / Chart UI / Single Page Web</div>
                </li>
            </ul>
