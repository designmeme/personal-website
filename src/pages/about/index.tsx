    ...
    return (
        <PageLayout frontmatter={frontmatter}>
            ...
            <p>
                ...
                그런 프로젝트를 함께하고 싶어요. 저를 고용하는 데 관심이 간다면 <Link to="./resume" onClick={() => gaEvent('navigation', 'click_resume', 'about')}>이력서 및 경력기술서</Link> 페이지를 봐주세요.
            </p>
            <hr/>
            <h5>연락주세요</h5>
            <p>
                ...
                <br/>
                이메일 주소 <a href={`mailto:${email}`} target="_blank" onClick={() => gaEvent('navigation', 'click_email', 'about')}>{email}</a>으로 언제든지 연락주세요 :)
            </p>
